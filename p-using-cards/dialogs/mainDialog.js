...
class MainDialog extends ComponentDialog{
     ...
     * @param {*} accessor
     */
    async run(turnContext, accessorDialogState){

        console.log('****************MainDialog.run****************');
        //create the dialogSet
        const dialogSet = new DialogSet(accessorDialogState);

        //add this dialog to the dialogSet created 
        dialogSet.add(this);
    ...
    async choiceCardStep(stepContext){
        ...
        return await stepContext.prompt('cardPrompt', promptOptions);
    ...
    async showCardStep(stepContext){
        ...
        default:
            await stepContext.context.sendActivity({
                //Activity:Attachments(Archivos adjuntos)
                attachments: [
                ...
                // Activity.attachmentLayout : The layout hint for multiple attachments. Default: list. Possible values include: 'list', 'carousel'
